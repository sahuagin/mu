//! Deferred tool schemas with load-on-first-call (mu-t4l5e).
//!
...
//! load-on-first-call (a call to a withheld name loads it and runs the call
...
impl DeferredTools {
    ...
    /// checks load-on-first-call makes, which is what keeps the two paths in
